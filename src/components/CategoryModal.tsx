...
const styles = StyleSheet.create({
  ...
  modalTitle: { color: theme.accent, fontFamily: 'monospace', fontSize: 9, letterSpacing: 3 },
  closeBtn: { padding: 2 },
  closeBtnText: { color: theme.cream3, fontSize: 18, lineHeight: 20 },
  row: { flexDirection: 'row', gap: 8, marginBottom: 14, alignItems: 'flex-end' },
  codeField: { width: 90 },
  flex1: { flex: 1 },
  ...
  colorRow: { flexDirection: 'row', gap: 7, paddingVertical: 6 },
  ...
  previewRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 14 },
  previewLabel: { color: theme.cream3, fontFamily: 'monospace', fontSize: 9, letterSpacing: 1.5 },
  previewBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 2 },
  previewCode: { fontFamily: 'monospace', fontSize: 11, fontWeight: '500' },
  previewTitle: { color: theme.cream2, fontFamily: 'monospace', fontSize: 11 },
  error: { color: '#d48a8a', fontFamily: 'monospace', fontSize: 10, marginBottom: 8 },
  actions: { flexDirection: 'row', gap: 8, justifyContent: 'flex-end', marginTop: 18 },
  btnGhost: {
    borderWidth: 1,
    borderColor: theme.border,
    borderRadius: 4,
  ...
  btnGhostText: { color: theme.cream3, fontFamily: 'monospace', fontSize: 10, letterSpacing: 2 },
  btnPrimary: {
  ...
  btnPrimaryText: { color: theme.surfaceDeep, fontFamily: 'monospace', fontSize: 10, letterSpacing: 2, fontWeight: '500' },
});
