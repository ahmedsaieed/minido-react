...
const styles = StyleSheet.create({
  ...
  code: { fontFamily: 'monospace', fontSize: 12, letterSpacing: 1 },
  title: { color: theme.cream3, fontFamily: 'monospace', fontSize: 11, flex: 1 },
  check: { color: theme.accent, fontSize: 11 },
  sep: { height: 1, backgroundColor: theme.borderSubtle, marginVertical: 2 },
  createNew: { color: theme.cream3, fontFamily: 'monospace', fontSize: 11, letterSpacing: 1 },
});
